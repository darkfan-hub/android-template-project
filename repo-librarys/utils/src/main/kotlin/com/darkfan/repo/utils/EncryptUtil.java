...
public class EncryptUtil {
    ...
    public static String encryptMD5File2String(String filePath) {
        File file = StringExtensionKt.isBlank(filePath) ? null : new File(filePath);
    ...
    public static String encryptMD5File2String(File file) {
        return ConvertUtil.bytes2HexString(encryptMD5File(file));
    }
    ...
    public static String encryptHmacMD5ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacMD5(data, key));
    }
    ...
    public static String encryptHmacSHA1ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacSHA1(data, key));
    }
    ...
    public static String encryptHmacSHA224ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacSHA224(data, key));
    }
    ...
    public static String encryptHmacSHA256ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacSHA256(data, key));
    }
    ...
    public static String encryptHmacSHA384ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacSHA384(data, key));
    }
    ...
    public static String encryptHmacSHA512ToString(byte[] data, byte[] key) {
        return ConvertUtil.bytes2HexString(encryptHmacSHA512(data, key));
    }
