...
/**
 * @author Fanfan Gu [Contact me.](mailto:stefan.gufan@gmail.com)
...
class KeyboardUtil private constructor() {
    ...
    companion object {
         ...
         */
        @JvmOverloads
        fun showSoftInput(context: Context, view: View, flags: Int = 0) {
            val imm = context.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager
                ?: return
         ...
         */
        fun hideSoftInput(context: Context, window: Window) {
        ...
        private const val sDecorViewDelta = 0
        ...
        private fun getContentViewInvisibleHeight(window: Window): Int {
            val contentView =
                window.findViewById<View>(android.R.id.content) ?: return 0
            val outRect = Rect()
            ...
            return Math.abs(contentView.bottom - outRect.bottom)
        }
        ...
        fun fixSoftInputLeaks(activity: Activity) {
            fixSoftInputLeaks(activity, activity.window)
        }
