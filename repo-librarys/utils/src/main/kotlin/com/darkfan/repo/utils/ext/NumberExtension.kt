...
import com.darkfan.repo.utils.ConvertUtil
...
fun Float.dpToPx(context: Context): Int {
    return ConvertUtil.dp2px(context, this)
}

fun Float.pxToDp(context: Context): Int {
    return ConvertUtil.px2dp(context, this)
}

fun Float.spToPx(context: Context): Int {
    return ConvertUtil.sp2px(context, this)
}

fun Float.pxToSp(context: Context): Int {
    return ConvertUtil.px2sp(context, this)
}