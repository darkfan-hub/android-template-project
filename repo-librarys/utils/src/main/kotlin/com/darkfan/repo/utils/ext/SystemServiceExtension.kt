...
@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
fun Context.userManager(): UserManager = getSystemService(Context.USER_SERVICE) as UserManager
...
//val Context.wifiManager: WifiManager = getSystemService(Context.WIFI_SERVICE) as WifiManager
