...
import com.darkfan.repo.image.internal.Utils;
...
public class CropCircleWithBorderTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.darkfan.repo.image.transformations.CropCircleWithBorderTransformation." + VERSION;
